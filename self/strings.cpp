...
int i = 0; do { cout<<name[i]; // it prints the whole string - as array
...
// let's findout the size of new_name string variable in memory
cout<<"Size of new_name string is: "<<sizeof(new_name)<<endl;
